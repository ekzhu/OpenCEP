...
class Tree:
    """
    Represents an evaluation tree. Implements the functionality of constructing an actual tree from OpenCEP.tree plan
    ...
    def __handle_primitive_event(self, tree_plan_leaf: TreePlanLeafNode, primitive_event_structure: PatternStructure,
        ...
        """
        # this is a temporary hack used until the procedure is modified to extract event details from OpenCEP.tree plan leaves
