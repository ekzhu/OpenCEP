...
import tweepy
from OpenCEP.plugin.twitter import TwitterCredentials
import json
import time
...
class TwitterInputStream(InputStream, tweepy.StreamListener):
    ...
    def __init__(self, search_words_list: list, time_limit=None):
        ...
        self.__auth = tweepy.OAuthHandler(TwitterCredentials.api_key,
                                          TwitterCredentials.api_secret_key)
        self.__auth.set_access_token(TwitterCredentials.access_token,
                                     TwitterCredentials.api_token_secret)
