...
def singleType1PolicyPatternSearchTest(createTestFile=False):
    ...
    pattern = Pattern(
        SeqOperator(PrimitiveEventStructure("AAPL", "a"), PrimitiveEventStructure(
            "AMZN", "b"), PrimitiveEventStructure("AVID", "c")),
    ...
    runTest("singleType1Policy", [
            pattern], createTestFile, eventStream=nasdaqEventStreamTiny)
...
def contiguousPolicyPatternSearchTest(createTestFile=False):
    ...
    runTest("contiguousPolicySingleList", [
            pattern], createTestFile, eventStream=nasdaqEventStreamTiny)
...
def contiguousPolicy2PatternSearchTest(createTestFile=False):
    ...
    runTest("contiguousPolicyMultipleLists", [
            pattern], createTestFile, eventStream=nasdaqEventStreamTiny)
...
def freezePolicyPatternSearchTest(createTestFile=False):
    ...
    runTest("freezePolicy", [pattern], createTestFile,
...
def freezePolicy2PatternSearchTest(createTestFile=False):
    ...
    runTest("freezePolicy2", [pattern], createTestFile,
            eventStream=nasdaqEventStreamTiny)
